...
Webflow.require('ix').init([
  ...
  {"slug":"fade-in-top-scroll-in","name":"Fade in top (scroll in)","value":{"style":{"opacity":1,"x":"0px","y":"-6px","z":"0px"},"triggers":[{"type":"scroll","stepsA":[],"stepsB":[]}]}},
  {"slug":"fade-in-bottom-scroll-in","name":"Fade in bottom (scroll in)","value":{"style":{"opacity":1,"x":"0px","y":"18px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"0%","stepsA":[{"opacity":1,"transition":"transform 1000ms ease 0, opacity 1000ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"fade-in-bottom-long-scroll-in","name":"Fade in bottom long (scroll in)","value":{"style":{"opacity":1,"x":"0px","y":"30px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"0%","stepsA":[{"opacity":1,"transition":"transform 1000ms ease 0, opacity 1000ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"fade-in-scroll-league-2","name":"Fade in scroll league 2","value":{"style":{},"triggers":[{"type":"scroll","stepsA":[{"transition":"transform 1000ms ease 0","x":"0px","y":"10px","z":"0px"}],"stepsB":[{"transition":"transform 200 ease 0","x":"0px","y":"-10px","z":"0px"}]}]}},
  ...
  {"slug":"enlarge-on-hover","name":"Enlarge on hover","value":{"style":{},"triggers":[{"type":"hover","stepsA":[{"transition":"transform 1000ms ease 0","scaleX":1.05,"scaleY":1.05,"scaleZ":1}],"stepsB":[{"transition":"transform 1000ms ease 0","scaleX":1,"scaleY":1,"scaleZ":1},{"transition":"transform 200 ease 0","x":"0px","y":"0px","z":"0px"}]}]}},
  {"slug":"color-on-hover","name":"Color on Hover","value":{"style":{},"triggers":[{"type":"hover","stepsA":[{"opacity":1,"transition":"transform 200 ease 0, opacity 200 ease 0"}],"stepsB":[]}]}},
  {"slug":"opacity-on-hover","name":"Opacity on hover","value":{"style":{"opacity":1,"x":"0px","y":"0px","z":"0px"},"triggers":[{"type":"hover","stepsA":[{"opacity":0.5,"transition":"opacity 400ms ease 0"}],"stepsB":[{"opacity":1,"transition":"opacity 400ms ease 0"}]}]}},
  {"slug":"fixed-signature","name":"Fixed Signature","value":{"style":{"opacity":0,"x":"0px","y":"0%","z":"0px","scaleX":1,"scaleY":1,"scaleZ":1},"triggers":[]}},
  {"slug":"show-signature","name":"Show signature ","value":{"style":{"opacity":0},"triggers":[{"type":"scroll","selector":".signature","stepsA":[{"opacity":0,"transition":"transform 1000ms ease 0, opacity 1000ms ease 0"}],"stepsB":[{"opacity":1,"transition":"transform 1000ms ease 0, opacity 100ms ease 0"}]},{"type":"load","stepsA":[{"opacity":1,"transition":"opacity 1500ms ease 0"}],"stepsB":[]}]}},
  {"slug":"show-arrow-up","name":"Show Arrow Up","value":{"style":{"opacity":0},"triggers":[{"type":"scroll","selector":".arrowup","stepsA":[{"opacity":0,"transition":"transform 1000ms ease 0, opacity 1000ms ease 0"}],"stepsB":[{"opacity":1,"transition":"transform 1000ms ease 0, opacity 100ms ease 0"}]},{"type":"load","stepsA":[{"opacity":1,"transition":"opacity 1500ms ease 0"}],"stepsB":[]}]}},
  {"slug":"fade-out-on-scroll","name":"Fade out on scroll","value":{"style":{"opacity":1},"triggers":[{"type":"scroll","stepsA":[{"wait":"90ms","opacity":0,"transition":"opacity 1000ms ease 0"}],"stepsB":[{"opacity":1,"transition":"opacity 1000ms ease 0"}]}]}},
  {"slug":"fade-in-on-load","name":"Fade in on load","value":{"style":{"opacity":0},"triggers":[{"type":"load","stepsA":[{"opacity":1,"transition":"opacity 1500ms ease 0"}],"stepsB":[]}]}},
  {"slug":"opacity-100-on-hover","name":"Opacity 100 on hover","value":{"style":{"opacity":0},"triggers":[{"type":"hover","stepsA":[{"opacity":1,"transition":"opacity 400ms ease 0"}],"stepsB":[{"opacity":0,"transition":"opacity 400ms ease 0"}]}]}}
]);
